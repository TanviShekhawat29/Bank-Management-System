        ...
        try{
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                    ...
                    // Assuming a simple condition for balance check (For example: Max withdrawal amount is 10000)
                    ...
                    // In a real-world scenario, here we would check the user's balance and update accordingly
